// -*- C++ -*-
//
// Package:    ECALSimHitsAnalyzer
// Class:      ECALSimHitsAnalyzer
// 
/**\class ECALSimHitsAnalyzer ECALSimHitsAnalyzer.cc FastMuonBremAnalyzers/ECALSimHitsAnalyzer/src/ECALSimHitsAnalyzer.cc
...
#include "FastMuonBremAnalyzers/ECALSimHitsAnalyzer/interface/ECALSimHitsAnalyzer.h" 
...
//
ECALSimHitsAnalyzer::ECALSimHitsAnalyzer(const edm::ParameterSet& iConfig)
{   
...
///////////////////////////////////////////////////////////////////////////////////////
ECALSimHitsAnalyzer::~ECALSimHitsAnalyzer()
{;}
///////////////////////////////////////////////////////////////////

// ------------ method called once each job just before starting event loop  ------------
void 
ECALSimHitsAnalyzer::beginJob()
{
...
void
ECALSimHitsAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  for(;it!=itend;++it)
 {
  ...
  std::cout << detid << " " << detid.rawId()
           ...
           if(it->energy() > 0.0) {
             ...
             += it->energy();
             id =  detid.rawId();
             EMDeposit = caloHitsEBTotE[detid.hashedIndex()];
...
void 
ECALSimHitsAnalyzer::beginRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
void 
ECALSimHitsAnalyzer::endRun(edm::Run const&, edm::EventSetup const&)
{
...
DEFINE_FWK_MODULE(ECALSimHitsAnalyzer);
