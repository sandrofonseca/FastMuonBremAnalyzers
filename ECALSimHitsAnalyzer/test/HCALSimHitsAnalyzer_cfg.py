...
'file:/storage2/dilson/fastsim/44X/full/CMSSW_4_4_0_pre7/src/SingleMuPt1000_cfi_GEN_SIM_DIGI2RAW_HLT_RAW2DIGI_L1Reco.root'
...
process.TFileService = cms.Service("TFileService",
                       fileName = cms.string('CaloFullSim_HCAL.root'),
                       closeFileFast = cms.untracked.bool(True)
       )

process.demo = cms.EDAnalyzer('HCALSimHitsAnalyzer',


     famosSimHitsLabel = cms.InputTag("g4SimHits","HcalHits"),#done!!!
