...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SingleElectronPt1000_cfi_py_GEN_FASTSIM_HLT_VALIDATION_CaloHits.root'),
...
#MUON Chambers
#process.MuonSimHits.MaterialEffectsForMuons.MuonBremsstrahlung = True
##################################################################################################
