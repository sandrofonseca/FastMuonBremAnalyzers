...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
     #'file:/storage2/sfonseca/CMSSW/FastSim_std/CMSSW_4_2_0/src/SingleMuPt1000_cfi_py_GEN_FASTSIM_STD_HLT_VALIDATION_sameRD.root'
      'file:test_HCALPhotons/SingleMuPt1000_cfi_py_GEN_FASTSIM_HLT_VALIDATION_CaloHits.root'
...
process.TFileService = cms.Service("TFileService",
                       fileName = cms.string('CaloFastSimHCAL.root'),
...
process.demo = cms.EDAnalyzer('HCALSimHitsAnalyzer',
       ...
       famosSimHitsLabel = cms.InputTag("famosSimHits","HcalHits"),
